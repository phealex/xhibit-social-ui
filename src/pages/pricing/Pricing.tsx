        ...
        <div className="flex flex-col gap-[30px] lg:flex-row">
          {PricingData.map((data, index) => (
            <div key={index} className="relative p-0.5">
              ...
              <Card style={{ backgroundColor: data.bgColor}} className={` relative w-full `}>
                <CardContent
                  className={`flex flex-col gap-[30px] !p-6  w-full `}
                >
                  ...
                  <div className="flex flex-col gap-9">
                    <div className="flex flex-col gap-5">
                      {data.features.map((feature, index) => (
                        <div key={index} className="flex gap-2 items-center">
                          <CheckIcon
                            size={20}
                            className=" text-home_gradient p-[3px] bg-[#8E9FAA] rounded-full"
                          />
                    ...
                    <Button
                      className={` ${
                        data.hasBorder
                          ? " bg-primary_blue hover:bg-primary_blue border-hidden hover:border-hidden"
