...
const About: FC = () => {
  return (
    <div className="w-full bg-home_gradient space-y-[100px] py-[60px]">
      ...
      <section className="w-full bg-dark_green/5 py-5">
        <div className="flex flex-col gap-[30px] w-[90%] mx-auto">
        <div className="flex flex-col gap-5">
          <h1 className="text-white font-Jakarta font-bold text-[31px] leading-[44px] text-center">
            From our founder
          </h1>
          <p className="text-[13px] font-normal font-Jakarta leading-6 text-white/80">
            Having personally experienced the transformative power of accessing
            international opportunities, I embarked on a journey that took me to
            Silicon Valley many years ago. This not only opened new doors for me
            but also for the incredible individuals I encountered along the way.
            <br />
            ...
            <br /> Similarly, organizations are no longer confined to a limited
            talent pool when exceptional skills are scattered globally.
            <br />I extend an invitation to you: join us in co-creating a future
            where remote work is seamlessly integrated, normalized, and trusted
            by both job seekers and organizations. Together, let's build a world
            where the potential of remote work knows no bounds.
          </p>
        </div>
      ...
      <section className="flex flex-col gap-[78px] py-[100px] w-[90%] mx-auto ">
        ...
        <div className="flex flex-row gap-2 items-center md:w-[80%] md:ml-auto lg:w-1/2">
          <img src={Teamwork} alt="" className="kite-clip-path w-[150px] h-[150px] "  />
          <div className="flex flex-col gap-[10px]">
        ...
        <div className="flex flex-row gap-2 items-center md:w-[80%] md:mr-auto lg:w-1/2">
          ...
          <img src={Teamwork} alt="" className="pentagon-clip-path w-[150px] h-[150px]" />
        </div>
      </section>
      <section className="w-full bg-primary_blue py-[50px] flex flex-col gap-[50px] ">
        ...
        Sign up now and connect with your next great hire! Your journey to exceptional talent begins here
        </p>
