...
export const servicesData: ServiceCardType[] = [
  {
    ...
    desc: "Hi, there. I am a presentation design and pitch deck specialist with over 8 years of experience. I have helped my clients raise over $10M in funding. So whether you're looking to secure funding, showcase your products/services, win new clients, or elevate your presentations to the next level, my skills can help you succeed...",
    images: [coinbaseProject, ServiceBanner, coinbaseProject, ProjectBanner],
    price: "2832",
