...
const ProjectsHeader: FC = () => {
  ...
  return (
    <div
      className={cn(
        "h-[350px] w-full bg-cover bg-center bg-no-repeat flex flex-col gap-10 justify-center items-center",
        view === "projects"
    ...
    >
      <div className="flex flex-col justify-center items-center gap-[10px] container w-full lg:w-[60%]">
        <h1 className="text-[31px] leading-[44px] font-medium text-center text-white">
