                ...
                <div className="flex gap-5 items-center flex-wrap">
                  {rateTypes.map((item, index) => (
                    <Button
                      ...
                      className={cn(
                        " bg-dark_green/10 hover:bg-dark_green/10 border !h-fit w-fit border-dark_green font-Jakarta font-medium text-base",
                        field.value === item && "bg-primary_blue border-none"
                      )}
                    >
                      {item}
                    </Button>
