      ...
      <CardContent className=" flex flex-col gap-[30px] p-4">
        <div className="flex flex-col gap-[30px]">
          ...
          <div className=" flex flex-col gap-4">
            {
              paymentOption && paymentOption === "crypto" ? (
                cryptoPaymentDetailsData.slice(0, (cryptoPaymentDetailsData.length - 2) ).map((data, index) => (
        ...
        {
              paymentOption && paymentOption === "crypto" ? (
                cryptoPaymentDetailsData.slice(cryptoPaymentDetailsData.length - 2).map((data, index) => (
                  <div className="flex items-center justify-between" key={index}>
                    <p className=" font-Jakarta font-medium text-xs text-dark_green/70">
                      {data.title}
                    </p>
