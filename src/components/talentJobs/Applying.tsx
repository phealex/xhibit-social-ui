...
const Applying: FC = () => {
  const { isApplied, isApplying } = useJobsDisplay();
  return (
    <div className="flex ">
      <div className=" w-full flex-col gap-5 hidden md:flex">
        ...
        <div className="flex items-center gap-4">
          <Button
            onClick={() => {
              useJobsDisplay.setState({ isApplying: false, isApplied: true });
            }}
            className=" bg-primary_blue text-white p-4 hover:bg-white hover:text-primary_blue border hover:border-primary_blue px-[60px]"
          >
            Send application
          </Button>
          <Button
            ...
            className="flex bg-transparent text-dark_green/50 border border-dark_green/50 p-4 hover:bg-transparent hover:text-dark_green/50 hover:border-dark-green/50 px-[60px]"
          >
            Cancel
          </Button>
        </div>
