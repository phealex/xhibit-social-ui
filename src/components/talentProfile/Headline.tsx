      ...
      {isShowData ? (
        <div className=" flex flex-col gap-[30px] my-auto ">
          ...
          <p className=" font-Jakarta font-normal text-base text-dark_green">
            Forging User-Business Synergy / Bridging the UX Divide with Seamless
            Design Solutions (USER EXPERIENCE DESIGNER)
          </p>
        </div>
      ) : (
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription className=" text-left w-[90%] font-Jakarta text-[16px] font-normal text-dark_green/70">
                  Introduce yourself by highlighting your key skills. Show how
                  you can be of value to potential employers.
                </DialogDescription>
              </DialogHeader>
              <Form {...form}>
                <form
